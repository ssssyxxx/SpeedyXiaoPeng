# Spec: Config Theme Colors

## Purpose

TBD — This spec defines requirements for applying the canonical theme color palette (Blue `#18B7F6`, Purple `#666BCE`, White `#D7EEF6`) across all game UI surfaces, ensuring visual consistency, readable text contrast, correct sprite rendering, and layout alignment with the config context.
