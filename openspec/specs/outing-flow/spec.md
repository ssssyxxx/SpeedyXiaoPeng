...
Defines the end-to-end outing flow for the pig character: the bottom-nav entry point, condition checks, departure countdown, and return dialog with events and rewards.
