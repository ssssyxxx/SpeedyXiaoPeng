...
Defines the pig diary panel: how it is opened, how entries are rendered (text-only and image+text), ordering, and how entries are written after an outing returns.
